...
| Disponibilidad | El servicio de pagos falla durante el horario pico de reservas. | Caída del Payments Service | API Gateway | El gateway redirige las solicitudes a un servicio de pagos secundario (replica) en menos de 3 segundos, manteniendo la funcionalidad. |
